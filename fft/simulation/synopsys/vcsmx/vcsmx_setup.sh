...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twifp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twifp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twrfp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twrfp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twifp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twifp4.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twrfp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twrfp4.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twqfp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twqfp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twqfp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_twqfp4.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/fft.v"                                           
fi
